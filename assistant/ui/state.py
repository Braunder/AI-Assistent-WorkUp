...
def get_tts_engine() -> TTSEngine:
    """Create (or return cached) TTSEngine singleton for Streamlit UI."""
    return TTSEngine(
...
def initialize_session_state() -> None:
    ...
    defaults: dict[str, Any] = {
        ...
        # web TTS controls / cache
        "web_tts_enabled": settings.tts_enabled,
        "web_tts_autoplay": True,
        "web_tts_audio_cache": {},
        "web_tts_autoplay_key": None,
    }
